    ...
    try {
      ...
      if (regenerate) {
        ...
        try {
          ...
          // No roadmap -> generate automatically
          ...
          <main className="mx-auto max-w-6xl px-5 py-10 md:px-8">
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-3 max-w-xl text-slate-500">
                Add your career goal, experience level and interests
      ...
      <div className="lg:pl-72">
        ...
        <header className="sticky top-0 z-20 flex h-24 items-center justify-between border-b border-slate-200 bg-white/95 px-5 backdrop-blur md:px-8">
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => navigate(-1)}
              className="flex items-center gap-2 rounded-xl border border-slate-200 px-3 py-2.5 text-sm font-semibold text-slate-600 transition hover:bg-slate-50"
            >
              <ArrowLeft size={17} />
        ...
        <main className="mx-auto max-w-[1500px] px-5 py-8 md:px-8 lg:px-10">
            ...
            <div className="flex flex-col justify-between gap-6 md:flex-row md:items-start">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 text-sm leading-7 text-slate-300 md:text-base">
                  A personalized path generated according to
          ...
          <div className="space-y-6">
            {phases.map((phase, index) => {
              // Backend sends recommendedCourse
              const course =
                phase?.recommendedCourse ||
                phase?.course ||
                null;

              // Backend sends youtube
              ...
              // If backend gives playlistId,
              // create real playlist URL
                  ...
                  <div className="mt-7">
                    ...
                    {!course && !youtube && (
                      <p className="mt-4 rounded-xl bg-slate-50 p-4 text-sm text-slate-500">
                        No learning resources found for this
                        phase.
                      </p>
                    )}
                  </div>
...
const Sidebar = ({
  ...
  return (
    <>
      ...
      {/* SIDEBAR */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-72 flex-col overflow-y-auto border-r border-slate-200 bg-white transition-transform duration-300 lg:translate-x-0 ${
          sidebarOpen
            ? "translate-x-0"
            : "-translate-x-full"
        }`}
